...
const dict: Record<'en' | 'es', Record<string, string>> = {
  en: {
    ...
    総合ポイント: 'Total points',
    救済スロット: 'Rescue slot',
    出場国が最少の1名のみ: 'Only the player with the fewest survivors',
    対象: 'Target',
    カ国: ' countries',
    所有: 'Owned',
    '救済スロットは、決勝トーナメント進出32カ国の中から1国を、出場国が最も少ない参加者に追加します。選ばれた国はその人の9カ国目としてポイントに加算されます。':
      'The rescue slot adds one of the 32 knockout teams to the player with the fewest surviving countries. The selected country becomes their 9th country and counts toward their points.',
    '決勝T国の取得上限(1国最大2人)を適用': 'Apply knockout-team owner cap (max 2 per country)',
    '決勝トーナメント進出国の確定後に使えます': 'Available after knockout qualifiers are confirmed',
    救済は使用済みです: 'Rescue has already been used',
    今回の出目: 'Result',
    回す: 'Spin',
    この国を取る: 'Take this country',
    ルーレット対象: 'Roulette pool',
    決勝T進出国から救済スロットを回してください: 'Spin the rescue slot from knockout teams',
    追加できる決勝トーナメント進出国がありません: 'No knockout team can be added',
    スロット回転中: 'Slot spinning',
    '保存に失敗しました。合言葉を確認してください': 'Save failed. Check the passphrase.',
    放送スケジュール: 'Broadcast schedule',
    '日付時間順・地上波は局名': 'Kickoff order; terrestrial TV shows channel names',
    オッズ予想: 'Odds forecast',
    オッズなし: 'No odds',
    ...
    終了: 'Final',
    引分: 'Draw',
    '決勝トーナメントの日程を取得中…': 'Loading knockout schedule...',
    // rules editor
    勝ち: 'Win',
    PK勝ち: 'PK win',
    '3点差勝ち': '3+ goal win',
  ...
  es: {
    ...
    救済スロット: 'Rescate',
    出場国が最少の1名のみ: 'Solo quien tiene menos clasificados',
    対象: 'Objetivo',
    カ国: ' países',
    所有: 'Tiene',
    '救済スロットは、決勝トーナメント進出32カ国の中から1国を、出場国が最も少ない参加者に追加します。選ばれた国はその人の9カ国目としてポイントに加算されます。':
      'El rescate añade uno de los 32 equipos de eliminatorias al jugador con menos países vivos. El país elegido será su 9.º país y suma puntos.',
    '決勝T国の取得上限(1国最大2人)を適用': 'Aplicar límite de dueños en eliminatorias (máx. 2 por país)',
    '決勝トーナメント進出国の確定後に使えます': 'Disponible cuando se confirmen los clasificados',
    救済は使用済みです: 'El rescate ya se usó',
    今回の出目: 'Resultado',
    回す: 'Girar',
    この国を取る: 'Tomar este país',
    ルーレット対象: 'Bolsa de ruleta',
    決勝T進出国から救済スロットを回してください: 'Gira el rescate con países clasificados',
    追加できる決勝トーナメント進出国がありません: 'No hay país clasificado que añadir',
    スロット回転中: 'Girando',
    '保存に失敗しました。合言葉を確認してください': 'No se pudo guardar. Revisa la contraseña.',
    放送スケジュール: 'Calendario de TV',
    '日付時間順・地上波は局名': 'Orden de inicio; TV abierta muestra el canal',
    オッズ予想: 'Pronóstico de cuotas',
    オッズなし: 'Sin cuotas',
    ...
    終了: 'Final',
    引分: 'Empate',
    '決勝トーナメントの日程を取得中…': 'Cargando calendario de eliminatorias...',
    勝ち: 'Victoria',
